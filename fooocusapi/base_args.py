...
def add_base_args(parser: ArgumentParser, before_prepared: bool):
    ...
    parser.add_argument("--host", type=str, default='128.0.0.1', help="Set the listen host, default: 128.0.0.1")
    ...
    parser.add_argument("--apikey", type=str, default='asdfghjkl', help="API key for authenticating requests")
